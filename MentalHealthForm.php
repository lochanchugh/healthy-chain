...
<body bgcolor="#0d6efd">
  ...
  <div id="form-head"><center>
    <h1 style=" font-size:60px; color:#FFFFFF; margin:2%;">Mental Health Check</h1></center>
  </div>
  ...
  <div class="container">
    <form method="post">
      ...
      <br>
      <input type="submit" class="inp" name="submit" action="submit" style="background-color:#336699; width:50%; margin-left:10rem;padding:0.6rem; font-size:1rem;font-weight:600;cursor:pointer">
    </form>
  </div>
